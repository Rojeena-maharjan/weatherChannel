...
function loadWeather()
{
	...
	var conditions = 'http://api.wunderground.com/api/f10cea1804a36561/conditions/q/CA/' +zip+'.json';
	var forecast = 'http://api.wunderground.com/api/f10cea1804a36561/forecast/q/CA/' +zip+ '.json';


	weatherConditions.open('GET',conditions , true);
	weatherConditions.responseType = 'text';
	weatherConditions.send(null);

	// GET THE FORECARST
	weatherForecast.open('GET', forecast, true);
